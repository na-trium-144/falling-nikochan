...
* <del>Install [MongoDB](https://www.mongodb.com/docs/manual/installation/) and run on `localhost:27017`</del>
* <del>Create a `.env` file with the following contents</del>
* Install dependencies
    ```sh
    pnpm install
    ```
* <del>Seeding the database with initial data</del>
    ```sh
    pnpm run seed
    ```
* Common files (chart/)
