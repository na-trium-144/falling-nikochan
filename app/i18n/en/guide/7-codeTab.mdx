...
- When you place the cursor over various commands such as `Note()` in the Code tab, the time bar will also move to the time corresponding to that note (but this is not 100% accurate).
- Falling Nikochan's unique commands are as follows.
  ...
  - `Beat(beat)` or `Beat(beat, a, b)`: Changes the beat.
    - For 4/4 beat, use `[[4, 4, 4, 4]]`,
    for 7/8 beat, use `[[4, 4, 4, 8]]`,
    for 4/4 + 3/4 beat, use `[[4, 4, 4, 4], [4, 4, 4]]`.
