...
- Added a feature that automatically adjusts the chart offset in real time while playing.
  - You can disable this in the options to set it manually as before.
- The frame rate setting option has been removed and is now automatically adjusted.
- Changed the specifications of the link copy/share button so that only the URL is copied with the copy button.
  - On PC, you can copy both text and URL as before from the "Share" menu, or post directly to <span className="text-lg/6">𝕏</span>.
  - On Android/iOS, pressing the "Share" button will display the OS sharing menu as before, allowing you to send it to other apps.
